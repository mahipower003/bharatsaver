...
import { LicVsPpfCalculator } from "@/components/calculators/LicVsPpfCalculator";
...
export default function LicVsPpfPageClient({
  params,
  dictionary,
  pageDict,
}: {
  ...
  const pageUrl = `${siteUrl}/${params.lang}/lic-vs-ppf-calculator`;
